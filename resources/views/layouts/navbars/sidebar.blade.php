            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                        <i class="far fa-address-book" style="color: #f4645f;"></i>
                        <span class="nav-link-text" style="color: #f4645f;">User Management</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('page.index') }}">
                        <i class="ni ni-planet text-blue"></i> FrontOffice
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route ('message.index')}}">
                        <i class="ni ni-pin-3 text-orange"></i> {{ __('Mensagens') }}
                    </a>
                </li>
                <li class="nav-item">
