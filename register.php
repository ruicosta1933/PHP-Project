                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="registerUser.php" enctype="multipart/form-data" method="post">

                            <div class="input-group col-md-12" >
                                <div class="form-group col-md-6" style="width:100%">
                                    <label>First Name</label>
                                    <input class="au-input au-input--full" type="text" name="first" placeholder="First Name" required>
                                </div>
                                <div class="form-group col-md-6"  style="width:100%">
                                    <label>Last Name</label>
                                    <input class="au-input au-input--full" type="text" name="last" placeholder="Last Name" required>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" name="confPassword" placeholder="Confirm Password" required>
                                </div>
